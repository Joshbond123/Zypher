...
BUGFIX v3: Fixed IndentationError -- all module-level code was indented by 2
           spaces, causing Python to raise IndentationError: unexpected indent
           on every invocation (even with || true the state.db was not cleared).
