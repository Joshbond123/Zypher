# AGENTS.md — Zypher Identity, Rules & Memory
  ...
  You have 5 Cerebras API keys available as env vars:
  - CEREBRAS_KEY_1, CEREBRAS_KEY_2, CEREBRAS_KEY_3, CEREBRAS_KEY_4, CEREBRAS_KEY_5

  Use model: `cerebras/qwen-3-235b-a22b-instruct-2507`
  ...
  | AI | Cerebras Qwen-3 235B (5 keys, round-robin) |

  ---

  *Last updated: 2026-05-18 — Zypher v2 with Supabase memory + browser*
